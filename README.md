...
```
cd && cd .. && rm -f holderbot.sh* || true && clear && sudo apt install && sudo apt-get install libjpeg-dev && wget https://raw.githubusercontent.com/erfjabplus/holderbot/main/holderbot.sh && chmod +x holderbot.sh && ./holderbot.sh
```
